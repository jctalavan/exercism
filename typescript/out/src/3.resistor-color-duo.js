...
function decodedValue(colors) {
    ...
    let firstColorValue = getValue(firstColor).toString();
    let secondColorValue = getValue(secondColor).toString();
    let resistorValue = firstColorValue.concat(secondColorValue);
    return parseInt(resistorValue);
}
exports.decodedValue = decodedValue;
//# sourceMappingURL=3.resistor-color-duo.js.map